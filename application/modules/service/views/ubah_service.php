                    ...
                    <div class="col-lg">
                        <div class="p-5">
                            <div class="text-center">
                                ...
                                <form action="<?= base_url();?>service/ubah" method="post" enctype="multipart/form-data">
                                ...
                                <label for="barbershop">Barbershop</label>
                                    <input type="barbershop" class="form-control form-control-user"
                                        id="barbershop" name="barbershop" placeholder="Enter Barbershop..."<?= $service['barbershop'] ?>">
